...
const Navbar = () => {
  return (
    <nav id="FU" className="nav navbar-expand-sm navbar-dark fixed-top bg-dark">
      <div className="container-fluid d-flex justify-content-between align-items-end line">
        <h2 className="navbar-brand">Finer_Things_In_Life.com</h2>
        <button
        ...
        >
          ...
          <div className="offcanvas-body">
            <ul className="navbar-nav me-auto justify-content-end flex-grow-1 pe-3 kids gap-3">
              <li
                className="nav-item"
                data-bs-dismiss="offcanvas"
                aria-label="Close"
              ...
              <li
                ...
                aria-label="Close"
              >
                <NavLink className="nav-link p-1" to="/products">
                  Products
                </NavLink>
              </li>
              <li
